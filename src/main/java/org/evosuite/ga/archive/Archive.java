...
public abstract class Archive implements Serializable {
     ...
     *
     * @param solution a {@link TestSuiteChromosome} object.
     * @return a {@link TestSuiteChromosome} object.
     */
    ...
    /**
     * Calculate the penalty of a {@link TestCase}. A
     * {@link TestCase} is penalised if it has functional mocks, or/and if it
